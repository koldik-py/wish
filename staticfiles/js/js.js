//const urlMain = 'https://wish-k.herokuapp.com',
...
function add_category (title, icon, main, elem) {
	...
	x.innerHTML = `<div class="box-category">
				...
				<div class="variant-icon">
					<input type="hidden" class="category-icon-add" >
					<img src="/static/media/fire.png" class="icon">
					<img src="/static/media/five.png" class="icon">
					<img src="/static/media/handshake-96.png" class="icon">
					<img src="/static/media/clock.png" class="icon">
					<img src="/static/media/dividend.png" class="icon">
					<img src="/static/media/flower.png" class="icon">
					<div class="line"></div>
					<img src="/static/media/work.png" class="icon">
					<img src="/static/media/update.png" class="icon">
					<img src="/static/media/razor.png" class="icon">
					<img src="/static/media/money.png" class="icon">
					<img src="/static/media/lightning.png" class="icon">
					<img src="/static/media/physics.png" class="icon">
					<div class="line"></div>
					<img src="/static/media/run.png" class="icon">
					<img src="/static/media/ball.png" class="icon">
					<img src="/static/media/exzort.png" class="icon">
					<img src="/static/media/money2.png" class="icon">
					<img src="/static/media/magic.png" class="icon">
					<img src="/static/media/tous.png" class="icon">
					<div class="line"></div>
					<img src="/static/media/hours.png" class="icon">
					<img src="/static/media/robot.png" class="icon">
					<img src="/static/media/chill.png" class="icon">
					<img src="/static/media/decrease.png" class="icon">
					<img src="/static/media/growth.png" class="icon">
					<img src="/static/media/yes-pure.svg" class="icon">
				</div>
			</div>
			<div class="push-exit">
			<img src="/static/media/delete.png" class="push-exit-img">
		</div>`
	x.querySelector('.push-exit').addEventListener('click', ()=> x.style.display = 'none')
	x.querySelectorAll('.icon').forEach( i => {
		i.addEventListener('click', ()=> )
	})
