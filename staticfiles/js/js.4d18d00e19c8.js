//const urlMain = 'https://c7f305bac599.ngrok.io',
		...
		function generate_event (date, result) {
			...
			if ((dateDjango in result) && choice.event.id == 1) {
				result[dateDjango].forEach( i => {
					if (!i["category.icon.url"]) i["category.icon.url"] = 'main/static/media/circle.png'
					...
					<div class="event">
						<div class="event-category">
							...
							<img src="main/static/media/yes.png" class="push-event-yes" style='display: none;'>
							<div class="push-event" style="visibility: hidden;">
								<img src="main/static/media/edit.svg" class="push-event-edit" >
								<img src="main/static/media/delete.png" class="push-event-delete">
							</div>
						</div>
				...
				result[dateDjango].forEach( i => {
					...
					<div class="event">
						<div class="event-category">
							...
							<img src="main/static/media/${i.progress}.png" class="event-progress">
						</div>
						<div class="event-content">
							<p class="event-content-text">${i["content"]}</p>
						</div>
				...
				if (choice.event.id == 1){
					newEvent.innerHTML = `
						<div class="event-category">
							...
							<div class="event-category-js">
								<img src="main/static/media/clock.png" class="event-category-icon">
								<div class="event-category-title" style="color: #0036C0; font-family: Roboto-regular;">Выбрать категорию</div>
							</div>

							<img src="main/static/media/yes.png" class="push-event-yes" style='display: none;'>
							<img src="main/static/media/delete.png" class="push-event-del" style='display: none;'>
					...
					newEvent.innerHTML = `
						<div class="event-category">
							...
							<img src="main/static/media/circle.png" class="event-progress" style='display: none;' >
							<img src="main/static/media/yes.png" class="push-event-yes" style='display: none;'>
							<img src="main/static/media/delete.png" class="push-event-del" style='display: none;'>
						</div>
						<div class="event-content">
...
function activite_note (elem) {
	...
	del.addEventListener('click', ()=> {
		fetch('http://localhost:8000/notes/json/deleteNote', {
			method: 'POST',
			headers: {
			'Content-Type': 'application/json',
			'X-CSRFToken': choice.csrf
...
function activite_task (elem) {
	...
	img.addEventListener('click', ()=> {
		...
		if (img.src == 'http://localhost:8000/main/static/media/circle.png'){
			...
			.then(i => i.json())
			.then(i => {if (i[0]==1) img.src = 'main/static/media/yes.png'})
			...
			.then(i => i.json())
			.then(i => {if (i[0]==1) img.src = 'main/static/media/circle.png'})
		}
	})
	...
	function delete_task (elem) {
		elem.addEventListener('click', (e)=> {
			...
			'http://localhost:8000/main/static/media/circle.png' ){

				let del = document.createElement('img');
				del.className = 'event-progress'
				del.src = 'main/static/media/delete.png'
...
function activiteFull () {
	...
	function user_exit () {
		...
		user.addEventListener('click', () => {
			if (push.style.opacity != 1) push.style.opacity = 1
			else push.style.opacity = 0
		})
	...
	function render_target(data) {
		...
		<div class="card-target">
			...
			<div class="push-target-menu" style="visibility: hidden;">
				<div class="target-menu-variable" ><img src="main/static/media/fire.png" class="target-menu-icon">Поставить цель</div>
				<div class="target-menu-variable" ><img src="main/static/media/edit.svg" class="target-menu-icon">Редактировать</div>
				<div class="target-menu-variable" ><img src="main/static/media/delete.png" class="target-menu-icon">Удалить</div>
			</div>
			...
			`<div class="card-target">
				<div class="photo-target-form" style="background: #737373;">
					<button class="photo-target-form-btn">
						<img src="main/static/media/flower.png" class="photo-target-form-btn-i">
				...
				<div class="target-main-form">
					...
					<div class="progress-target-form">
						...
						<div class="progress-target-p">
							...
							<img src="main/static/media/selector.svg">
